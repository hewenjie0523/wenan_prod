...
/// to also has a [AuvCupertinoNavigationBar] or a [CupertinoSliverNavigationBar]
...
///
/// By default, only one [AuvCupertinoNavigationBar] or [CupertinoSliverNavigationBar]
...
///
/// {@tool dartpad}
/// This example shows a [AuvCupertinoNavigationBar] placed in a [CupertinoPageScaffold].
...
class AuvCupertinoNavigationBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  /// Creates a navigation bar in the iOS style.
  const AuvCupertinoNavigationBar({
    Key? key,
    this.leading,
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.leading}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.automaticallyImplyLeading}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.previousPageTitle}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.trailing}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.backgroundColor}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.brightness}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.padding}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.border}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.transitionBetweenRoutes}
  ...
  /// {@template flutter.cupertino.AuvCupertinoNavigationBar.heroTag}
  /// Tag for the navigation bar's Hero widget if [transitionBetweenRoutes] is true.
  ///
  /// Defaults to a common tag between all [AuvCupertinoNavigationBar] and
  ...
  @override
  State<AuvCupertinoNavigationBar> createState() => _CupertinoNavigationBarState();
}
...
class _CupertinoNavigationBarState extends State<AuvCupertinoNavigationBar> {
...
///
/// Like [AuvCupertinoNavigationBar], it also supports a [leading] and [trailing]
...
/// See also:
///
///  * [AuvCupertinoNavigationBar], an iOS navigation bar for use on non-scrolling
///    pages.
class CupertinoSliverNavigationBar extends StatefulWidget {
  ...
  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.leading}
  ///
  /// This widget is visible in both collapsed and expanded states.
  final Widget? leading;

  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.automaticallyImplyLeading}
  final bool automaticallyImplyLeading;
  ...
  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.previousPageTitle}
  final String? previousPageTitle;
  ...
  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.trailing}
  ///
  /// This widget is visible in both collapsed and expanded states.
  final Widget? trailing;

  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.backgroundColor}
  final Color? backgroundColor;

  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.brightness}
  final Brightness? brightness;

  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.padding}
  final EdgeInsetsDirectional? padding;

  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.border}
  final Border? border;

  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.transitionBetweenRoutes}
  final bool transitionBetweenRoutes;

  /// {@macro flutter.cupertino.AuvCupertinoNavigationBar.heroTag}
  final Object heroTag;
...
class _LargeTitleNavigationBarSliverDelegate
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    return Hero(
      ...
      // CupertinoSliverNavigationBar like AuvCupertinoNavigationBar because it
...
// components that are used in common by the AuvCupertinoNavigationBar and
...
/// A nav bar back button typically used in [AuvCupertinoNavigationBar].
///
/// This is automatically inserted into [AuvCupertinoNavigationBar] and

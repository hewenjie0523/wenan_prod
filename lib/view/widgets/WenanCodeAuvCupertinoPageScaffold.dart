...
///    [AuvCupertinoPageScaffold] with support for iOS-style page transitions.
class AuvCupertinoPageScaffold extends StatefulWidget {
  /// Creates a layout for pages with a navigation bar at the top.
  const AuvCupertinoPageScaffold({
    Key? key,
    this.navigationBar,
  ...
  @override
  _AuvCupertinoPageScaffoldState createState() => _AuvCupertinoPageScaffoldState();
}

class _AuvCupertinoPageScaffoldState extends State<AuvCupertinoPageScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.navigationBar != null) {
      ...
      final double topPadding =
          widget.navigationBar?.preferredSize.height??0 + existingMediaQuery.padding.top;
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        color: widget.backgroundColor==null?CupertinoTheme.of(context).scaffoldBackgroundColor:CupertinoDynamicColor.resolve(widget.backgroundColor!, context),
      ),
      child: Stack(
        children: <Widget>[

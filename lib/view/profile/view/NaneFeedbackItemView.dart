...
class NaneCustomerServiceItemView extends ConsumerWidget {
  const NaneCustomerServiceItemView({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return UIUtils.settingItemWidget(
        _ellipsisText(
            StringTranslate.e2z(AppLocalizations.of(context)!.wenan_string_customer_service),
            context),

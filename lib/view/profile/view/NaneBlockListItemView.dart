...
class NaneBlockItemWidget extends ConsumerWidget {
  const NaneBlockItemWidget({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return UIUtils.settingItemWidget(
        _ellipsisText(
            StringTranslate.e2z(AppLocalizations.of(context)!.wenan_string_blacklist), context),
        endIcon: _commonArrowIcon(), onPressed: () {
      PageRouter.pushPage(context, PageRouter.BlackListPage);
    });
  }
